...
* KiroTrace Cloud SecOps Log Monitoring
...
* Local KiroTrace Evidence Retrieval
* Local Ollama LLM Integration
* `phi3:mini` Local Security Assistant
* `nomic-embed-text` Embedding Model
* Evidence Attribution
* Confidence Normalization
* Structured Security Response Validation
* Controlled Security Tool Execution
* Tool Intent Detection
* Tool Policy Enforcement
* Target Validation
* Dangerous Shell-Control Blocking
* Tool Orchestration
* Docker Sandbox Execution
* Sandbox Policy Enforcement
* Assistant Activity Audit Logging
* JSONL-Based Audit Trail
* Session and Context Management
* Local Vector Memory
* Streamlit Security Assistant Dashboard
...
These tools should only be used on systems where proper permission has been granted. Unauthorized scanning, testing, or access attempts against systems without permission are strictly prohibited.

The purpose of this portfolio is to demonstrate cybersecurity learning, defensive security concepts, automation skills, and practical security engineering practices.
